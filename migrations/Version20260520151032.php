 ...
 */
final class Version20260520151032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE freedict_catalog ADD pending_steps JSON DEFAULT \'{}\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE freedict_catalog DROP pending_steps');
